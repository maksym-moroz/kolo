...
3. Read [quality-tooling-map.md](/Users/maksymmoroz/startup/kolo/docs/planning/foundation/quality-tooling-map.md) before changing CI, formatting, lint, or dependency analysis
4. Read [udf-store-contract.md](/Users/maksymmoroz/startup/kolo/docs/planning/foundation/udf-store-contract.md) before building feature state layers
5. Use those docs to drive implementation tickets from [backlog.md](/Users/maksymmoroz/startup/kolo/docs/planning/backlog.md)
